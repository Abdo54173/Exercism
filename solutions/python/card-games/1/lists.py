...
def approx_average_is_average(hand):
    ...
    avr_of_first_and_last =(hand[0] + hand[-1]) / 2

    middle_index =len(hand) // 2
    middle =hand[middle_index]

    return avr == avr_of_first_and_last or avr == middle
...
def average_even_is_average_odd(hand):
    ...
    return card_average(even_nums) == card_average(odd_nums)
